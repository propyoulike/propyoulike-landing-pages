...
export default function LoanEligibilityWidget({ onCtaClick, banks = [] }: { onCtaClick?: () => void; banks?: any[] }) {
  ...
  // ---------------- RENDER ----------------
  return (
    <section id="loan-eligibility" className="py-16 lg:py-24 bg-muted/30">
      <div className="container mx-auto px-4 space-y-10 max-w-5xl flex flex-col lg:flex-row gap-8">
        ...
        {/* RIGHT SUMMARY + BANKS */}
        <div className="hidden lg:block w-[350px] sticky top-[100px] self-start">
          <SummaryCard
            computed={computed}
