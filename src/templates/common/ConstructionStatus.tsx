                    ...
                    <div className="p-6">
                      ...
                      {isOpen && (
                        <div className="space-y-6 animate-accordion-down">
                          ...
                          {/* Status */}
                          {Array.isArray(tower.status) && tower.status.length > 0 && (
                            <div>
                          ...
                          {/* Achieved */}
                          {Array.isArray(tower.achieved) && tower.achieved.length > 0 && (
                          ...
                          {/* Upcoming */}
                          {Array.isArray(tower.upcoming) && tower.upcoming.length > 0 && (
                            <div className="border-t pt-4">
                              <div className="flex items-center gap-2 mb-2">
